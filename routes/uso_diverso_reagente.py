...
@uso_diverso_reagente_blueprint.route('/', methods=['GET'])
@login_required
...
def cadastrar_uso_diverso_reagente():
    ...
    return redirect(url_for('uso_diverso_reagente.uso_diverso_reagente'))


@uso_diverso_reagente_blueprint.route('/editar', methods=['POST'])
@login_required
...
@uso_diverso_reagente_blueprint.route('/deletar', methods=['POST'])
@login_required
